...
<model ref="r:564b4c06-4df3-411c-8d2f-3714256fe7ba(servicespraak.structure)">
  ...
  <node concept="1TIwiD" id="6OISXMHQR$s">
    ...
    <node concept="PrWs8" id="3LBiIJRlZ5L" role="PzmwI">
      <ref role="PrY4T" to="f6cw:4iVB5Q1RPKo" resolve="ICanHaveBron" />
    </node>
    <node concept="PrWs8" id="3LBiIJRmqvd" role="PzmwI">
      <ref role="PrY4T" to="f6cw:1MP9utIs32t" resolve="IHaveMetatags" />
    </node>
    <node concept="PrWs8" id="3LBiIJRxHbX" role="PzmwI">
      <ref role="PrY4T" to="4slc:JO3t1XMH7w" resolve="IRapportageRoot" />
    </node>
    <node concept="1QGGSu" id="3LBiIJRp6vp" role="rwd14">
      <property role="1iqoE4" value="${module}/icons/Lijst.svg" />
    </node>
  </node>
