...
public class MOutputParameterTest extends AbstractOutputTest {
    @Test
    public void testEmptyParameterValue() throws IOException {
        final MOutputParameter parameter = new MOutputParameter("param", "param", false, new BooleanToBooleanWriter());
    ...
    public void testStringParameterValue() throws IOException {
        final MOutputParameter parameter = new MOutputParameter("param", "param", false, new StringToStringWriter());
        final MUniverse universe = new MUniverse(true);
    ...
    public void testOnlyOutputWhenEvaluated() throws IOException {
        final MOutputParameter parameter = new MOutputParameter("param", "param", true, new BooleanToBooleanWriter());
        final MUniverse universe = new MUniverse(true);
        universe.setParameter("param", true);
        final String actualOutput = generateOutput(parameter, universe);
        final String expectedJson = """
    ...
    private String generateOutput(MOutputParameter parameter, MUniverse universe) throws IOException {
