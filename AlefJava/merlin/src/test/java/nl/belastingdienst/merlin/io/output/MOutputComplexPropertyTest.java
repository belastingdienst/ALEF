...
public class MOutputComplexPropertyTest {
    @Test
    public void testCollection() throws IOException {
        ...
        final MOutputComplexProperty<ItemType> complexProperty = new MOutputComplexProperty<>("items", null, false, true,
    ...
    public void testSingle() throws IOException {
        ...
        final MOutputMessage mockItem = new MOutputMessageMock();
        mockItem.addField(new MOutputAttribute<>("name", false, ItemType.name, new StringToStringWriter()));
        final MOutputComplexProperty<ItemType> complexProperty = new MOutputComplexProperty<>("item", null, false, false,
                FactPersonHasItems.items, ItemType.class, mockItem);
        // When
        final String actualOutput = generateOutput(complexProperty, universe, alefPerson, ContentType.XML);
        // Then
    ...
    public void testEnclosedCollection() throws IOException {
        ...
        final MOutputMessage mockItem = new MOutputMessageMock();
        mockItem.addField(new MOutputAttribute<>("name", false, ItemType.name, new StringToStringWriter()));
        final MOutputComplexProperty<ItemType> complexProperty = new MOutputComplexProperty<>("items", "item", false, true,
                FactPersonHasItems.items, ItemType.class, mockItem);
        // When
        final String actualOutput = generateOutput(complexProperty, universe, alefPerson, ContentType.XML);
        // Then
    ...
    public void testWithNoRole() throws IOException {
        ...
        final MOutputMessage mockItem = new MOutputMessageMock();
        mockItem.addField(new MOutputAttribute<>("name", false, ItemType.name, new StringToStringWriter()));
        final MOutputComplexProperty<ItemType> complexProperty = new MOutputComplexProperty<>("items", "item", false, true, null, ItemType.class, mockItem);
        // When
    ...
    public void testWithNoObjectType() throws IOException {
        ...
        // Given (mapping)
        final MOutputMessage mockParam = new MOutputMessageMock();
        mockParam.addField(new MOutputParameter<>("name", "paramName", false, new StringToStringWriter()));
        final MOutputComplexProperty<ItemType> complexProperty = new MOutputComplexProperty<>("param", null, false, true, null, null, mockParam);
        // When
        final String actualOutput = generateOutput(complexProperty, universe, null, ContentType.XML);
        // Then
        final String expectedOutput = """
    ...
    public void testWithObjectTypeNoRoleKeyAndMainObject() throws IOException {
        ...
        mockPerson.addField(new MOutputAttribute<>("name", true, PersonType.name, new StringToStringWriter()));
        final MOutputComplexProperty<PersonType> complexProperty = new MOutputComplexProperty<>("person", null, false, true, null, PersonType.class, mockPerson);
        // When
    ...
    public void testSingleWithKvPairSection() throws IOException {
        ...
        final MOutputMessage mockItem = new MOutputMessageMock();
        mockItem.addField(new MOutputAttribute<>("name", false, ItemType.name, new StringToStringWriter()));
        final MOutputComplexProperty<ItemType> complexProperty = new MOutputComplexProperty<>("items", null, false, false,
                FactPersonHasItems.items, ItemType.class, mockItem);
        // When
        final String actualOutput = generateOutput(complexProperty, universe, alefPerson, ContentType.KV_PAIR);
        // Then
    ...
    public void testRequiredWithKvPairSection() throws IOException {
        ...
        final MOutputMessage mockItem = new MOutputMessageMock();
        mockItem.addField(new MOutputAttribute<>("name", false, ItemType.name, new StringToStringWriter()));
        final MOutputComplexProperty<ItemType> complexProperty = new MOutputComplexProperty<>("items", null, true, false,
                FactPersonHasItems.items, ItemType.class, mockItem);
        // When
        final String actualOutput = generateOutput(complexProperty, universe, alefPerson, ContentType.KV_PAIR);
        // Then
    ...
    public void testRequiredTrueWithEmptyCollection() throws IOException {
        ...
        final MOutputMessage mockItem = new MOutputMessageMock();
        mockItem.addField(new MOutputAttribute<>("name", false, ItemType.name, new StringToStringWriter()));
        final MOutputComplexProperty<ItemType> complexProperty = new MOutputComplexProperty<>("items", "item", true, true,
                FactPersonHasItems.items, ItemType.class, mockItem);
        // When
        final String actualOutput = generateOutput(complexProperty, universe, alefPerson, ContentType.XML);
        // Then
    ...
    private String generateOutput(MOutputComplexProperty<?> complexProperty, MUniverse universe, MObject alefObject, ContentType contentType) throws IOException {
