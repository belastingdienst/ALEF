...
public class ParserLocationTest {
    ...
    @Test
    public void testLocationInfoWithNormalCollection() throws IOException {
    ...
    private ContentParser createParser(ContentType type, String input) throws IOException {
