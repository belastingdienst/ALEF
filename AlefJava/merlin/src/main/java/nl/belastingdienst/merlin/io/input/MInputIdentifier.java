...
public class MInputIdentifier implements MInputElement {
    private final String fieldName;
    private final boolean required;

    public MInputIdentifier(String fieldName, boolean required) {
    ...
    public void parse(MUniverse universe, IMPropertyHolder propertyHolder, ContentParser parser) {
        // nothing to parse here, the identifier is handled by the MInputMessage class
    }
}
