...
public abstract class MInputProperty<TAlef> implements MInputElement {
    ...
    public MInputProperty(String fieldName, boolean required, TAlef defaultValue, MPropertyKey<TAlef> propertyKey, Integer dimensionKey) {
