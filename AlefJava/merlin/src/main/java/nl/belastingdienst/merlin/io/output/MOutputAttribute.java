...
public class MOutputAttribute<TAlef> implements MOutputField {
    ...
    public MOutputAttribute(String fieldName, boolean required, MPropertyKey<TAlef> propertyKey, MWriter<TAlef> writer) {
        this(fieldName, required, propertyKey, null, writer);
    }

    public MOutputAttribute(String fieldName, boolean required, MPropertyKey<TAlef> propertyKey, Integer dimensionKey, MWriter<TAlef> writer) {
