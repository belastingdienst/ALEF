...
public abstract class MSoapService<T extends MObjectType> extends MService<T> {
    private final MContentType contentType;
    private final String methodName;
    private final String messageName;

    public MSoapService(boolean useLazyEval, String serviceVersion, MContentType contentType,
    ...
    private MObject parseSoapEnvelope(MUniverse universe, ContentParser parser) throws IOException {
        ...
        expectFieldName("Header", parser);
        parser.nextValue(); // for empty header
    ...
    private void expectFieldName(String expectedFieldName, ContentParser parser) throws IOException {
        final String actualFieldName = parser.nextName();
        if (!Objects.equals(expectedFieldName, actualFieldName)) {
            throw new IllegalStateException("Expected field name '" + expectedFieldName
                    + "' but found '" + actualFieldName + "'");
        }
    }
