...
2. macOS blokkeert standaard niet ondertekende apps. Dit kun je oplossen door:
    1. Een terminal te openen: klik rechts op de uitgepakte app en houd command-toets (&#8984;) ingedrukt.
